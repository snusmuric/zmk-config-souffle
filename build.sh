...
west build -d build/sofle_left -b nice_nano_v2 -- -DZMK_CONFIG="/workspaces/zmk-config/config" -DSHIELD="sofle_left"  
west build -d build/sofle_right -b nice_nano_v2 -- -DZMK_CONFIG="/workspaces/zmk-config/config" -DSHIELD="sofle_right"
